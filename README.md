...
Usage: (compile and) run the java program. Before running, pass the location of your hosts file (if you're on windows, just input "windows" instead) and the URL from where to download.<br><br>
